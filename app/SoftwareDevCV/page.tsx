    ...
    <div className="max-w-4xl mx-auto p-8 font-sans">
      ...
      <div className="text-center border-b-2 border-black pb-4 mb-6">
        ...
        <div className="text-sm">
          Kfar Sava, 4428053 |
          <a className="mx-1 hover:underline" href="tel:0506441480">
            0506441480
          </a>{" "}
          |
          <a
          ...
          |
          <a className="hover:underline" href="https://github.com/EyalLabel/">
            GitHub
          </a>
        </div>
      </div>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          foundation in both front-end and back-end development, with expertise
          in C#, Java, and React.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <strong>Additional Skills:</strong> Agile Methodologies, System
      ...
      <section className="mb-6">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              Designed and implemented responsive user interfaces for complex
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc pl-5">
            <li>
              Conducted real-time analysis of web threats including phishing
              sites and malware
            </li>
            <li>
              Developed automated solutions to streamline threat detection
              processes
            </li>
            <li>
              Collaborated with security teams to implement rapid response
              protocols
            </li>
            <li>
              Enhanced system efficiency through process automation and
              optimization
            </li>
          </ul>
        </div>
      ...
      <section className="mb-6">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc pl-5">
            <li>
              Comprehensive training in full-stack development with Java, MySQL,
              Spring, React, and Javascript
            </li>
            <li>
              Developed multiple full-stack applications as course projects
            </li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc pl-5">
            <li>
              Advanced coursework in programming and computer science principles
            </li>
